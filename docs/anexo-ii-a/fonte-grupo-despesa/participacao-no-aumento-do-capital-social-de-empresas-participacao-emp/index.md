...
<strong class="loa-card__valor">R$ 238,00 mil</strong>
<span class="loa-card__exato">R$ 238.000,00</span>
</div>
<div class="loa-card">
...
<div class="loa-tabela" id="tabela-fonte-grupo-despesa-participacao-no-aumento-do-capital-social-de-empresas-participacao-emp" data-id="fonte-grupo-despesa-participacao-no-aumento-do-capital-social-de-empresas-participacao-emp">
  ...
  <div class="loa-rolagem">
    <table style="min-width:74rem">
      ...
      <tbody>
        <tr data-nivel="1" data-num="0"><td class="loa-col--texto">TOTAL</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="119000.00">R$ 119.000,00</td><td class="loa-col--numero" data-valor="119000.00">R$ 119.000,00</td></tr><tr data-nivel="1" data-num="1"><td class="loa-col--texto">61 - RECURSOS DIRETAMENTE ARRECADADOS COM VINCULAÇÃO ESPECÍFICA</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="110000.00">R$ 110.000,00</td><td class="loa-col--numero" data-valor="110000.00">R$ 110.000,00</td></tr><tr data-nivel="1" data-num="2"><td class="loa-col--texto">10 - RECURSOS ORDINÁRIOS - RECURSOS NÃO VINCULADOS DE IMPOSTOS</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="0.00">R$ 0,00</td><td class="loa-col--numero" data-valor="9000.00">R$ 9.000,00</td><td class="loa-col--numero" data-valor="9000.00">R$ 9.000,00</td></tr><tr class="loa-total"><td class="loa-col--texto">TOTAL</td><td class="loa-col--numero">R$ 0,00</td><td class="loa-col--numero">R$ 0,00</td><td class="loa-col--numero">R$ 0,00</td><td class="loa-col--numero">R$ 238.000,00</td><td class="loa-col--numero">R$ 238.000,00</td></tr>
      </tbody>
    </table>
  </div>
</div>
