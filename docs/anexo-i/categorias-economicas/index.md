...
<div class="loa-tabela" id="tabela-categorias-economicas" data-id="categorias-economicas">
  ...
  <div class="loa-rolagem">
    <table>
      ...
      <thead><tr><th class="loa-col--texto" data-coluna="0" data-tipo="texto" tabindex="0" role="columnheader" aria-sort="none">Especificação</th><th class="loa-col--texto" data-coluna="1" data-tipo="texto" tabindex="0" role="columnheader" aria-sort="none">Lado</th><th class="loa-col--numero" data-coluna="2" data-tipo="dinheiro" tabindex="0" role="columnheader" aria-sort="none">Valor</th></tr></thead>
      <tbody>
        <tr data-nivel="1" data-num="0"><td class="loa-col--texto">RECEITAS CORRENTES</td><td class="loa-col--texto">receita</td><td class="loa-col--numero" data-valor="122820764605.00">R$ 122.820.764.605,00</td></tr><tr data-nivel="1" data-num="1"><td class="loa-col--texto">DESPESAS CORRENTES</td><td class="loa-col--texto">despesa</td><td class="loa-col--numero" data-valor="117014652734.00">R$ 117.014.652.734,00</td></tr><tr data-nivel="1" data-num="2"><td class="loa-col--texto">RECEITAS DE CAPITAL</td><td class="loa-col--texto">receita</td><td class="loa-col--numero" data-valor="4324690575.00">R$ 4.324.690.575,00</td></tr><tr data-nivel="1" data-num="3"><td class="loa-col--texto">DESPESAS DE CAPITAL</td><td class="loa-col--texto">despesa</td><td class="loa-col--numero" data-valor="14171726388.00">R$ 14.171.726.388,00</td></tr><tr data-nivel="1" data-num="4"><td class="loa-col--texto">RESERVA DE CONTIGÊNCIA</td><td class="loa-col--texto">despesa</td><td class="loa-col--numero" data-valor="1177567620.00">R$ 1.177.567.620,00</td></tr><tr data-nivel="1" data-num="5"><td class="loa-col--texto">TOTAL</td><td class="loa-col--texto">receita</td><td class="loa-col--numero" data-valor="127145455180.00">R$ 127.145.455.180,00</td></tr><tr data-nivel="1" data-num="6"><td class="loa-col--texto">TOTAL</td><td class="loa-col--texto">despesa</td><td class="loa-col--numero" data-valor="132363946742.00">R$ 132.363.946.742,00</td></tr><tr data-nivel="1" data-num="7"><td class="loa-col--texto">DÉFICIT</td><td class="loa-col--texto">receita</td><td class="loa-col--numero" data-valor="-5218491562.00">R$ -5.218.491.562,00</td></tr>
      </tbody>
    </table>
  </div>
</div>
...
!!! info "Sobre estes dados"
    Fonte primária: `categorias_economicas.csv` — o mesmo arquivo que gera o PDF oficial.
